import InteractionData_ext as pd
import InteractionEntry_ext as pe
import sys
...
if o.size() != 2:
	...
	sys.exit(1)
print("setting new instance energy to 500.2")
ne.setEnergy(500.2)
print(" ")
...
str(ae.getPositionZ()) + "),t=" + str(ae.getTime()) + ",E=" +
str(ae.getEnergy()))
if (ae.getPositionX() != 4.0 or ae.getPositionY() != 2.0 or 
	ae.getPositionZ()!= 4.2 or ae.getTime() != 0 or ae.getEnergy() != 0):
...
str(ae.getPositionZ()) + "),t=" + str(ae.getTime()) + ",E=" +
str(ae.getEnergy()))
if (ae.getPositionX() != 0 or ae.getPositionY() != 0 or 
	ae.getPositionZ()!= 0 or ae.getTime() != 0 or ae.getEnergy() != 500.2):
	print("init values of instance do not match returned values")
	sys.exit(1)
...
print("-----------------------------------------------------------------------")
print("Test of InteractionData successfully completed")
